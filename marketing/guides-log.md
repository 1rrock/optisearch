...
자동 발행 루틴이 매일 1편씩 추가하는 가이드 글의 발행 기록.

---

## 2026-04-29 (시범 발행)
- 키워드: 블로그 부업 시작 가이드
- slug: blog-side-job-guide
- 카테고리: 실전 활용
- 제목: 직장인 블로그 부업 시작 가이드: 첫 6개월 로드맵
- guides URL: https://www.optisearch.kr/guides/blog-side-job-guide (배포 후)
- 네이버 초안: marketing/naver-drafts/2026-04-29-blog-side-job-guide.md

## 2026-04-30
- 키워드: 블로그 키워드 찾는 법 무료
- slug: find-blog-keywords-free
- 카테고리: 키워드 분석
- 제목: 블로그 키워드 찾는 법: 무료 도구로 시작하는 3단계 발굴법
- guides URL: https://www.optisearch.kr/guides/find-blog-keywords-free (배포 후)

## 2026-05-01
- 키워드: 블로그 SEO 점수 측정하는 법
- slug: blog-seo-score-check
- 카테고리: 블로그 SEO
- 제목: 블로그 SEO 점수 측정하는 법: 지금 당장 내 블로그를 진단하는 방법
- guides URL: https://www.optisearch.kr/guides/blog-seo-score-check (배포 후)

## 2026-05-02
- 키워드: 블로그 글 빨리 쓰는 법
- slug: blog-write-faster
- 카테고리: 콘텐츠 마케팅
- 제목: 블로그 글 빨리 쓰는 법: 1시간 안에 완성하는 5단계 루틴
- guides URL: https://www.optisearch.kr/guides/blog-write-faster (배포 후)

## 2026-05-04
- 키워드: 블로그 애드센스 승인 받는 법
- slug: blog-adsense-approval
- 카테고리: 실전 활용
