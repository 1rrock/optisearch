...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "무료 플랜은 하루 10회 키워드 검색, AI 제목 3회, 초안·점수 각 1회를 이용할 수 있으며 인기글 TOP3과 3개월 트렌드를 제공합니다. 베이직 플랜부터는 무제한 검색, 인기글 TOP7, 섹션 분석, 성별/연령 필터, 쇼핑 인사이트 등 모든 기능을 이용하실 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "옵티써치는 글로벌 결제 플랫폼 Paddle을 통해 안전하게 결제가 이루어집니다. 신용카드, 체크카드, 페이팔 등 다양한 결제 수단을 지원하며, 결제 정보는 Paddle의 보안 시스템에 의해 암호화되어 처리됩니다.",
  },
  {
    question: "데이터는 안전한가요?",
    answer:
